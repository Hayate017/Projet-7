    ...
    <div role="dialog" aria-modal="true" aria-hidden="true" tabindex="-1">
        <div v-if="showDeletionModale" class="deletion" role="document">
            ...
            <div class="deletion__modale">
                ...
                <div v-on:click="closeModale" v-on:keydown.enter="closeModale" tabindex="0"
                    class="deletion__modale__btn cancel-btn">ANNULER</div>
                <div v-on:click="deletePost" v-on:keydown.enter="deletePost" tabindex="0"
                    class="deletion__modale__btn validate-btn">CONFIRMER</div>
            </div>
        </div>
    </div>
</template>
