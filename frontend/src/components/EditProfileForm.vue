        ...
        <div class="edit__form__container">
            ...
            <form class="edit__form">
                ...
                <div class="edit__form__bloc">
                    ...
                    <input v-model="newUsername" class="edit__form__bloc__input" type="text" id="username"
                        contenteditable spellcheck="false">
                </div>
                <div class="edit__form__bloc">
                    <label class="edit__form__bloc__label" for="content">Bio :</label>
                    <textarea v-model="newBio" class="edit__form__bloc__textarea" type="text" id="bio" contenteditable
                        spellcheck="false" placeholder="Dites-nous en plus sur vous."></textarea>
                </div>
                <div class="edit__form__bloc btn__bloc__container">
                    <div class="btn__bloc">
                        <label v-on:keydown.enter="keydownTrigger" tabindex=0 role="button"
                            class="edit__form__bloc__file__label" for="file"><i class="fa-solid fa-image"></i></label>
                        <input v-on:change="previewFile" type="file" class="edit__form__bloc__file__input" id="file">
                    </div>
                    <div class="btn__bloc">
                        <button v-on:click.prevent="editProfile" class="edit__form__bloc__submit-btn"><i
