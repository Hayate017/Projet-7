<template>
    <div class="login">
        <form class="login__form">
            ...
            <input class="login__form__input" v-model="email" type="email" id="email" contenteditable spellcheck="false"
                required>
            <p class="error__message">{{ mailErrorMessage }}</p>

            <label class="login__form__label" for="password">Mot de passe <i v-on:click="showPassword"
                    class="fa-solid fa-eye showPasswordIcon"></i></label>
            <input class="login__form__input" v-model="password" v-bind:type="passwordFieldType" id="password"
