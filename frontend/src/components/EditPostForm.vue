<template>
    <div role="dialog" aria-labelledby="modaleHeading" aria-describedby="modaleForm" aria-modal="true"
        ...
        <div v-if="showEditModale" class="modale__container" role="dialog">
            ...
            <div class="edit__form__modale">
                <div v-on:click="closeEditModale" v-on:keydown.enter="closeEditModale" class="close-btn" role="button"
                    tabindex="1"><i class="fa-solid fa-xmark"></i></div>
                ...
                <form id="modaleForm" class="edit__form">
                    <div class="edit__form__bloc">
                        ...
                        <input v-model="title" class="edit__form__bloc__input" type="text" id="title" contenteditable
                            spellcheck="false" required>
                    </div>

                    <div class="edit__form__bloc">
                        <label class="edit__form__bloc__label" for="content">Message :</label>
                        <textarea v-model="content" class="edit__form__bloc__textarea" type="text" id="content"
                            contenteditable spellcheck="false" required></textarea>
                    </div>
                    <div class="edit__form__bloc btn__bloc__container">
                        <div class="btn__bloc">
                            <label v-on:keydown.enter="keydownTrigger" tabindex=0 role="button"
                                class="edit__form__bloc__file__label" for="file"><i
                                    class="fa-solid fa-image"></i></label>
                            <input v-on:change="previewFile" type="file" class="edit__form__bloc__file__input"
                                id="file">
                        </div>
                        <div class="btn__bloc">
                            <button v-on:click.prevent="editPublication" v-on:keydown.prevent="editPublication"
                                class="edit__form__bloc__submit-btn"><i class="fa-solid fa-paper-plane"></i></button>
                        </div>
                    </div>
