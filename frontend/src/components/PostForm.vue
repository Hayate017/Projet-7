    ...
    <div>
        <div class="post__form__container">
            <div class="post__form__header">
                ...
                <div v-if="isVisible" v-on:click="isVisible = !isVisible" v-on:keydown.enter="isVisible = !isVisible"
                    class="post__form__header__btn" role="button" tabindex="0"><i class="fa-solid fa-xmark"></i></div>
            </div>
            <form v-if="isVisible" class="post__form">
                <div class="post__form__bloc">
                    <label class="post__form__bloc__label" for="title">Titre :</label>
                    <input v-model="title" class="post__form__bloc__input" type="text" id="title" contenteditable
                        spellcheck="false" required>
                </div>

                <div class="post__form__bloc">
                    <label class="post__form__bloc__label" for="content">Message :</label>
                    <textarea v-model="content" class="post__form__bloc__textarea" type="text" id="content"
                ...
                <div class="post__form__bloc btn__bloc__container">
                    <div class="btn__bloc">
                        <label v-on:keydown.enter="keydownTrigger" tabindex=0 role="button"
                            class="post__form__bloc__file__label" for="file"><i class="fa-solid fa-image"></i></label>
                        <input v-on:change="previewFile" type="file" class="post__form__bloc__file__input" id="file">
                    </div>
                    <div class="btn__bloc">
                        <button v-on:click.prevent="postPublication" v-on:keydown.enter.prevent="postPublication"
                            class="post__form__bloc__submit-btn"><i class="fa-solid fa-paper-plane"></i></button>
                    </div>
                </div>
