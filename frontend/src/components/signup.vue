<template>
    <div class="signup">
        <form class="signup__form">
            ...
            <input class="signup__form__input" v-model="username" v-on:input="checkUsername" type="text" id="username"
                contenteditable spellcheck="false" required>
            <p class="error__message">{{ usernameErrorMessage }}</p>

            <label class="signup__form__label" for="email">Email</label>
            <input class="signup__form__input" v-model="email" v-on:input="checkEmail" type="email" id="email"
                contenteditable spellcheck="false" required>
            <p class="error__message">{{ mailErrorMessage }}</p>

            <label class="signup__form__label" for="password">Mot de passe <i v-on:click="showPassword"
                    class="fa-solid fa-eye showPasswordIcon"></i></label>
            <input class="signup__form__input" v-model="password" v-on:input="checkPassword"
                v-bind:type="passwordFieldType" id="password" contenteditable spellcheck="false" required>
            <p class="error__message">{{ passwordErrorMessage }}</p>

            <label class="signup__form__label" for="passwordConfirm">Confirmez le mot de passe <i
                    v-on:click="showPassword" class="fa-solid fa-eye showPasswordIcon"></i></label>
            <input class="signup__form__input" v-model="passwordConfirm" v-bind:type="passwordFieldType"
                id="passwordConfirm" contenteditable spellcheck="false" required>
